      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Text('EduguardLK', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
              Container(
                margin: const EdgeInsets.only(top: 24.0, bottom: 24.0),
                  child: const Column(
                    children: [
                      Text('SIGN IN', style: TextStyle(fontSize: 32.0, fontWeight: FontWeight.bold),),
                      Text('Select your account type', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w400),),
                    ],
                  ),
              ),
              Row(
