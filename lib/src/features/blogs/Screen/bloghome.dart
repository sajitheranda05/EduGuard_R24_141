...
import 'package:eduguard/src/features/blogs/widget/blogtitle.dart';
...
class BlogHome extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _BlogHome();
}
                                  ...
                                  children: [
                                    ...
                                    Obx(() {
                                      ...
                                      return GridView.builder(
                                        itemCount:
                                            controller.paginatedblogs.length,
                                        shrinkWrap: true,
                                        physics:
                                            const NeverScrollableScrollPhysics(),
                                        gridDelegate:
                                        ...
                                        itemBuilder: (_, index) {
                                          final blog =
                                              controller.paginatedblogs[index];
                                          return BlogTitle(blog: blog);
                                        },
                                      );
                                    }),
                                    const SizedBox(height: 20),
