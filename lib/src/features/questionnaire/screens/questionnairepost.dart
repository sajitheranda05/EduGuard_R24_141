...
import 'package:eduguard/src/features/questionnaire/screens/addqs_copy.dart';
import 'package:eduguard/src/features/questionnaire/widget/questionnire.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:get/get_core/src/get_main.dart';

class QuestionnairePost extends StatefulWidget {
  const QuestionnairePost({super.key});

  @override
  State<StatefulWidget> createState() => _QuestionnairePost();
}

class _QuestionnairePost extends State<QuestionnairePost> {
  @override
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Get.to(const AddQsCopy()); // Example action
                          },
                          child: const Icon(
                    ...
                    Obx(() {
                      ...
                      return GridView.builder(
                        itemCount: controller.paginatedqs.length,
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        gridDelegate:
                            const SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        itemBuilder: (_, index) {
                          final qs = controller.paginatedqs[index];
                          return Questionnire(qs1: qs);
                        },
                      );
                    }),
                    const SizedBox(height: 20),
